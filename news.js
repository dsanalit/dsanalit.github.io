...
{
  "date": "2025-10-15",
  "title": "Fete de la Science 2025",
  "description": "Each year, the Fête de la Science opens the doors of research and discovery to the public across France. This year at Sorbonne Université, we showcased our latest works at the edge of human-robot interactions.",
  "image": "images/fete_science.jpg",
  "link": "https://www.linkedin.com/posts/sorbonne-universite_fds2025-activity-7383506316931203072-ZZJe?utm_source=share&utm_medium=member_desktop&rcm=ACoAACSiFGIB5mLI0mpfQFw5RKL5OFakhyC1UaM"
},
{
  "date": "2025-10-10",
  ...
  sortedNews.forEach(item => {
    ...
    card.innerHTML = `
      ...
      <div class="news-content">
        <time datetime="${item.date}">  ${new Date(item.date).toLocaleDateString('en-GB', {
    day: 'numeric',
    month: 'long',
    year: 'numeric'
  })} </time>
